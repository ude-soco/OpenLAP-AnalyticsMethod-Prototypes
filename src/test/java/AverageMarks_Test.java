...
import com.openlap.AnalyticsMethods.Prototypes.Assignment.AverageMarks;
...
public class AverageMarks_Test {
    public static final String DATASET_RESOURCE_PATH = "/AverageMarks_data.json";
    public static final String CONFIGURATION_RESOURCE_PATH = "/AverageMarks_config.json";


    public static void main(String[] args) {
        AverageMarks_Test context = new AverageMarks_Test();
        ObjectMapper mapper = new ObjectMapper();
        // Prettify the output
        mapper.configure(SerializationFeature.INDENT_OUTPUT, true);
        try {
            //Loading the OpenLAP DataSet from AverageMarks_data.json
            OpenLAPDataSet inputDataSet = mapper.readValue(context.loadResourceFile(DATASET_RESOURCE_PATH), OpenLAPDataSet.class);

            //Loading the OpenLAP Port Cofiguration from AverageMarks_config.json
            ...
            AnalyticsMethod method = new AverageMarks();
