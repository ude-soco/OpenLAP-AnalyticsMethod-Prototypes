...
import com.openlap.AnalyticsMethods.Prototypes.Assignment.PointsImprovement;
 ...
 * on 23-Mar-16.
 */
public class PointsImprovement_Test {
    public static final String DATASET_RESOURCE_PATH = "/PointsImprovement_data.json";
    public static final String CONFIGURATION_RESOURCE_PATH = "/PointsImprovement_config.json";


    public static void main(String[] args) {
        PointsImprovement_Test context = new PointsImprovement_Test();
        ...
        try {
            ...
            AnalyticsMethod method = new PointsImprovement();

            // Add parameters and initialize it
            Map<String, String> params = new HashMap<String, String>();
            params.put("improvement_type", "Min and Max Points Obtained");
