...
import com.openlap.AnalyticsMethods.Prototypes.Assignment.MarksStatistics;
 ...
 * on 23-Mar-16.
 */
public class MarksStatistics_Test {
    public static final String DATASET_RESOURCE_PATH = "/MarksStatistics_data.json";
    public static final String CONFIGURATION_RESOURCE_PATH = "/MarksStatistics_config.json";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AnalyticsMethod method = new MarksStatistics();
